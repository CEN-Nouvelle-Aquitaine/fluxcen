...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.stackedWidget.setGeometry(QtCore.QRect(660, 10, 221, 61))
        self.stackedWidget.setObjectName("stackedWidget")
        self.page_3 = QtWidgets.QWidget()
        self.page_3.setObjectName("page_3")
        self.commandLinkButton_4 = QtWidgets.QCommandLinkButton(self.page_3)
        self.commandLinkButton_4.setGeometry(QtCore.QRect(10, 20, 201, 41))
        font = QtGui.QFont()
        ...
        self.commandLinkButton_5 = QtWidgets.QCommandLinkButton(self.page_4)
        self.commandLinkButton_5.setGeometry(QtCore.QRect(10, 20, 151, 41))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
        ...
        self.commandLinkButton_6 = QtWidgets.QCommandLinkButton(self.page_5)
        self.commandLinkButton_6.setGeometry(QtCore.QRect(10, 20, 141, 41))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
        self.commandLinkButton_6.setFont(font)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/plugins/FluxCEN/scan25.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.commandLinkButton_4.setText(_translate("Dialog", "  Ajouter fond de carte OSM"))
        self.commandLinkButton_5.setText(_translate("Dialog", "  Ajouter fond ortho"))
        self.commandLinkButton_6.setText(_translate("Dialog", "  Ajouter Scan 25"))
