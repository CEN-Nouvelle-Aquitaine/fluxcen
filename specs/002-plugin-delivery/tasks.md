...
- [ ] T022 [US2] Valider en conteneur puis sur le POC : tag `v5.3.2-beta.1` → seul le catalogue beta bouge ; tag `v5.3.2` → stable et beta à jour ; vérifier l'absence de secret dans les réglages du repo (SC-005) et le délai < 10 min (SC-004)
